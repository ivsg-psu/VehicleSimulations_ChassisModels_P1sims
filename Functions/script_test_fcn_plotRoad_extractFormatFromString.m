%% script_test_fcn_plotRoad_extractFormatFromString.m
% This is a script to exercise the function:fcn_plotRoad_extractFormatFromString
...
if 1==1
    fprintf(1,'\n\nComparison of fcn_plotRoad_extractFormatFromString without speed setting (slow) and with speed setting (fast):\n');
