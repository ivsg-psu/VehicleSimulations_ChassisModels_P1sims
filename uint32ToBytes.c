 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Apr 02 13:15:36 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                uint32ToBytes
...
extern void uint32ToBytes_Outputs_wrapper(const int32_T *u0,
  uint8_T *y0,
  uint8_T *y1,
  uint8_T *y2,
  uint8_T *y3);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  uint32ToBytes_Outputs_wrapper(u0, y0, y1, y2, y3);
}
