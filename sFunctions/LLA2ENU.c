 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Apr 01 17:13:46 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                LLA2ENU
...
extern void LLA2ENU_Outputs_wrapper(const real_T *u0,
  const real_T *u1,
  const real_T *u2,
  const real_T *u3,
  const real_T *u4,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  LLA2ENU_Outputs_wrapper(u0, u1, u2, u3, u4, u5, y0, y1, y2);
}
